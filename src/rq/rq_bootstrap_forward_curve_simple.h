/**
 * \file rq_bootstrap_forward_curve_simple.h
 * \author Brett Hutley
 *
 * \brief A simple function to bootstrap a forward curve
 */
/*
** rq_bootstrap_forward_curve_simple.h
**
...
*/
#ifndef rq_bootstrap_forward_curve_simple_h
#define rq_bootstrap_forward_curve_simple_h
