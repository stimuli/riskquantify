/*
** rq_bootstrap_adapter_yield_curve_day_count.c
**
...
RQ_EXPORT const char * const rq_bootstrap_adapter_yield_curve_day_count_id = "BootstrapYieldCurveDayCount";

void *
bootstrap_yield_curve_day_count( 
...
rq_bootstrap_adapter_yield_curve_day_count_alloc()
{
    return 
        _rq_bootstrap_adapter_alloc(
            rq_bootstrap_adapter_yield_curve_day_count_id,
