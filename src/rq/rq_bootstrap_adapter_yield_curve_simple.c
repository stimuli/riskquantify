/*
** rq_bootstrap_adapter_yield_curve_simple.c
**
...
RQ_EXPORT const char * const rq_bootstrap_adapter_yield_curve_simple_id = "BootstrapYieldCurveSimple";

void *
bootstrap_yield_curve_simple(
...
{
    rq_yield_curve_t yield_curve = rq_bootstrap_yield_curve_simple(
        curve_id,
        system,
        market,
        NULL,
...
rq_bootstrap_adapter_yield_curve_simple_alloc()
{
    return 
        _rq_bootstrap_adapter_alloc(
            rq_bootstrap_adapter_yield_curve_simple_id,
