/*
** rq_bootstrap_adapter_yield_curve_spread.c
**
...
const char * const rq_bootstrap_adapter_yield_curve_spread_id = "BootstrapYieldCurveSpread";

void *
bootstrap_yield_curve_spread(
...
{
    rq_yield_curve_t yield_curve = rq_bootstrap_yield_curve_spread(
        curve_id,
        system,
        market,
        NULL,
...
rq_bootstrap_adapter_yield_curve_spread_alloc()
{
    return 
        _rq_bootstrap_adapter_alloc(
            rq_bootstrap_adapter_yield_curve_spread_id,
