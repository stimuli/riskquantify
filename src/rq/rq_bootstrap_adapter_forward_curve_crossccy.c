/*
** rq_bootstrap_adapter_forward_curve_crossccy.c
**
...
const char * const rq_bootstrap_adapter_forward_curve_crossccy_id = "BootstrapForwardCurveCrossCcy";

static void *
bootstrap_forward_curve_crossccy(
    ...
    )
{
    ...
    rq_forward_curve_mgr_t fcmgr = rq_market_get_forward_curve_mgr(market);
    if (bootstrap_config)
    {
        rq_forward_curve_t forward_curve = rq_bootstrap_forward_curve_crossccy(
...
rq_bootstrap_adapter_forward_curve_crossccy_alloc()
{
    return 
        _rq_bootstrap_adapter_alloc(
            rq_bootstrap_adapter_forward_curve_crossccy_id,
            RQ_TERMSTRUCT_TYPE_FORWARD_CURVE,
            bootstrap_forward_curve_crossccy
            );
}
